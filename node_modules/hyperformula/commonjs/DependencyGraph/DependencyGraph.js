...
var _collectAddressesDependentToMatrix = require("./collectAddressesDependentToMatrix");
...
var DependencyGraph = /*#__PURE__*/function () {
  ...
  _createClass(DependencyGraph, [{
    ...
    value: function breakNumericMatrix(matrixVertex) {
      ...
      try {
        for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
          ...
          var valueVertex = new _2.ValueCellVertex(this.getCellValue(address), this.getRawValue(address));
    ...
    value: function expandMatricesAfterAddingRows(sheet, rowStart, numberOfRows) {
      var _iterator49 = _createForOfIteratorHelper(this.matrixMapping.numericMatricesInRows(_Span.RowsSpan.fromRowStartAndEnd(sheet, rowStart, rowStart))),
          _step49;
    ...
    value: function expandMatricesAfterAddingColumns(sheet, columnStart, numberOfColumns) {
      var _iterator51 = _createForOfIteratorHelper(this.matrixMapping.numericMatricesInColumns(_Span.ColumnsSpan.fromColumnStartAndEnd(sheet, columnStart, columnStart))),
          _step51;
    ...
    value: function getAdjacentNodesAddresses(inputVertex) {
      ...
      deps.forEach(function (vertex) {
        ...
        if (castVertex instanceof _2.RangeVertex) {
          ret.push(new _AbsoluteCellRange.AbsoluteCellRange(castVertex.start, castVertex.end));
        } else if (castVertex instanceof _2.FormulaCellVertex) {
